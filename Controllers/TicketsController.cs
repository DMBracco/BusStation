...
namespace BusStation.Controllers
{
    ...
    public class TicketsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Tickets.Include(t => t.Passengers).Include(t => t.Routes);
        ...
        public async Task<IActionResult> Create([Bind("Id,Seat,PassengerId,RouteId")] Ticket ticket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Seat,PassengerId,RouteId")] Ticket ticket)
        {
            if (id != ticket.Id)
            {
                return NotFound();
